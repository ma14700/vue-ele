<template>
  <div>
      ...
      <transition name="fade">
          <div class="activities_details" v-if="showActivities && shopDetailData">
              <h2 class="activities_shoptitle">
               ...
               <h3 class="activities_ratingstar">
                ...
                <div class="activities_list">
                    <div class="activities_title_style"><span>优惠信息</span></div>
                    <ul>
                ...
                <div class="activities_shopinfo">
                    <div class="activities_title_style"><span>商家公告</span></div>
                    <p>{{promotionInfo}}</p>
                </div>
      ...
      <transition name="fade-choose">
          <div class="food_container" v-show="changeShowType=='food'">
